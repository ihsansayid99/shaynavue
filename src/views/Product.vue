            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="gambardef" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == gambardef ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == gambardef ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == gambardef ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == gambardef ? 'active' : ''"
                    >
